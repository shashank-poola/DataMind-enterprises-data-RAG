...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* ── Right: form ── */}
      <div className="flex-1 flex flex-col" style={{ background: "#0A0908" }}>
        <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 max-w-[520px] mx-auto w-full">
          <div className="lg:hidden mb-10">
            <span style={{ fontFamily: "var(--font-screener)", fontSize: "1.4rem", color: "#F0EDE8" }}>
              DataMind
            </span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              {loading ? (
                <>
                  <DotmSquare11 size={16} dotSize={2.5} color="#6A6560" speed={1.2} />
                  Signing in…
                </>
              ) : (
                "Sign in"
        ...
        >
          <p className="text-xs" style={{ color: "#3A3835", fontFamily: "var(--font-screener)" }}>
            ...
            <a href="#" className="underline underline-offset-2" style={{ color: "#5A5652" }}>Terms of Service</a>{" "}
            and{" "}
            <a href="#" className="underline underline-offset-2" style={{ color: "#5A5652" }}>Privacy Policy</a>
          </p>
          <p className="text-xs">
